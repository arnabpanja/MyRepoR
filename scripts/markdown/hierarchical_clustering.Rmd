...
```
As we can see the US Arrests data has `r dim(df.arrests)[1]` observations and `r dim(df.arrests)[2]` variables. The observations corespond to each of the 50 states of US. We can have a glimpse of the data by using the head function. 
